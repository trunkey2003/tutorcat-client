...
export default function LiveRoom({ roomID }) {
  ...
  return (
    <>
      ...
      <div onClick={handleClassChatBox} className={`fixed bottom-[330px] flex justify-center items-center w-[40px] h-[60px] bg-sky-900 z-[1001] rounded-r-xl ${classChatToogle}`}>
